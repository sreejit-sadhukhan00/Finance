...
// Type-safe categoryColors object
interface CategoryColorMap {
  [key: string]: string;
}

export const categoryColors: CategoryColorMap = defaultCategories.reduce<CategoryColorMap>((acc, category) => {
  acc[category.id] = category.color;
  return acc;
}, {});

// Export types for use in other components
export type { Category, CategoryType, CategoryColorMap };